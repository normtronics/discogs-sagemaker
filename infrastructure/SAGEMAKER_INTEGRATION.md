...
Use the provided notebook template (see `sagemaker-notebook-example.ipynb`) or run directly:
...
- See `sagemaker-notebook-example.ipynb` for a complete notebook template
